...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "timesheet/employeetimesheet/test/integration/FirstJourney",
    "timesheet/employeetimesheet/test/integration/TimesheetsListJourney",
    "timesheet/employeetimesheet/test/integration/TimesheetsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
