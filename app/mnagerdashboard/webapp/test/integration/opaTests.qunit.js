...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "mnagerdashboard/test/integration/FirstJourney",
    "mnagerdashboard/test/integration/TimesheetsListJourney",
    "mnagerdashboard/test/integration/TimesheetsObjectPageJourney",
    "mnagerdashboard/test/integration/TimesheetEntriesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
